...
//   // Listener para añadir nuevos pins 
//   var addedPins = [];
...
//     var activeScene = scenes.find(s => viewer.scene() === s.scene);
...
//     addedPins.forEach(function(hotspotObj) {
//       hotspotObj.destroy(); 
//     });
//     addedPins = []; 
...
//       title: "Nuevo Pin",
//       icon: "img/hotspots/pin.svg"
//     });


//     var hotspotObj = activeScene.scene.hotspotContainer().createHotspot(pin, {
//       yaw: coords.yaw,
//       pitch: coords.pitch
//     });


//   addedPins.push(hotspotObj);
// });
